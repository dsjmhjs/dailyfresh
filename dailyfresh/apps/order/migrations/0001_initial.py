# Generated by Django 2.1.4 on 2019-01-06 07:19
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('total_price', models.DecimalField(decimal_places=2, max_digits=10, verbose_name='商品总价格')),
                ('transit_price', models.DecimalField(decimal_places=2, max_digits=10, verbose_name='商品运费')),
                ('order_status', models.SmallIntegerField(choices=[(1, '待支付'), (2, '待发货'), (3, '待收款'), (4, '待评价'), (5, '已完成')], default=1, verbose_name='商品状态')),
